...
final class TestJwtTokens {
  ...
  static String issue(String secret, String tenantId, String userId, List<String> permissions) {
    return issue(secret, tenantId, userId, permissions, Instant.now().plusSeconds(1800));
  }
